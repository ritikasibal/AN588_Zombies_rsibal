---
title: "rsibal_FinalHomeworkCode_03"
author: "Ritika Sibal"
date: "`r Sys.Date()`"
output:
...
*Jess's comments: Fun! I watched this TV series a few years back, it combines zombies and crime. What's not to love?! I also haven't embedded a video in an RMD file yet, but I'm definitely going to use that link to do so for the next homework assignment.*
``` {r load_data}
...
*Jess's comments: Wow, I like how you made the plotting into a function- that's very efficient. Also, not at all necessary but maybe consider adding some color to your plots.*
``` {r Question 2}
library(ggplot2)
...
*Jess's comments: Excellent work! Our scatterplots and correlation findings are quite similar, which makes sense considering the variables.*
``` {r Question 3}
...
*Jess's comments: You are killing this assignment! Again, our histograms/ Q-Q plots and findings are nearly identical. However, I believe the quantitative variables (zombies killed and years of education) drawn from a non-normal distribution are right skewed, not left. I also made this mistake- it is not intuitive. Also, you did not note which common distribution the non-normal variables were drawn from. I'm thinking Poisson distribution.*
``` {r Question 4}
...
# No, not normal dist. This looks like a right skewed distribution based on the convex qqnorm curve and the visual histogram. Possibly a poison distribution
...
*Jess's comments: Your code for this question is so well-organized! I found it challenging to write my code for the variables not drawn from a normal distribution, but you made it look effortless. I will keep this in mind to improve my own code. Well done!*
``` {r Question 5}
library(dplyr)
...
*Jess's comments: Cool! We used similar approaches and obtained similar results.*
``` {r Question 6}
library(dplyr)
...
*Jess's comments: You did AMAZING, Ritika! P.S. Don't forget to include your homework challenges/ reflection.*

## Reflection 
**When I was coding:**

*3 things were difficult: *
<br> 1) The code felt super clunky at times, I felt like I wasn't doing things as efficiently as possible so I spent a lot of time trying to make my code easy to follow
<br> 2) I am still not having the best time graphing (especially the ggplot)! Practice is making it better though!
<br> 3) I was trying to find a best fit plot for question 4 (e.g. Poission), but I had a hard time doing that!

*3 ways your peers commentary helped you:*
<br> 1) I had missed that the distribution was left not right skewed! My peer correctly pointed that out
<br> 2) I had not guessed what the distribution looked like (e.g. possibly a poission), my peer also correctly pointed that out!
<br> 3) My partner said my code was easy to follow which was great to hear because I was worried it was not intuitive at all!
...
<br> 2) My peer plotted the normal and QQ plots again for the last question--something I missed but I think was helpful!

*1 thing that could use improvement:*
<br> 1) Honestly I thought my peers code was great! As someone who had coded for a long time, I felt like my partners code was very easy to follow and intuitive! I thought he did an amazing job!